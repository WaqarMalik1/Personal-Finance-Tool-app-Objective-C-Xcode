...
@interface OutgoingMasterViewController ()
@property (nonatomic)AddNewExpenseViewController* addExpVC;
@end

@implementation OutgoingMasterViewController


@synthesize summarytotaloutgoing = _summarytotaloutgoing;
...
- (void)insertNewObject:(OutgoingHolder*)expense {
   ...
   // [newManagedObject setValue:[NSDate date] forKey:@"timeStamp"];
    ...
    outgoing.recuringswitch = expense.recuringswitch;
    NSError *error = nil;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
   ...
   // if ([[segue identifier] isEqualToString:@"toincoming"]) {
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"Balance %.2f Date/Time: %@",[outgoing.amount floatValue], outgoing.date];
    
    _summarytotaloutgoing = _summarytotaloutgoing + [outgoing.amount floatValue];
    NSLog(@"total outgoing %f", _summarytotaloutgoing);
}
